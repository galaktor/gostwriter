...
const (
	...
	CODE_ROTATE_DISPLAY           = Code(C.KEY_ROTATE_DISPLAY)           /* 153   */
	CODE_DIRECTION                = Code(C.KEY_DIRECTION)                /* KEY_ROTATE_DISPLAY */
	...
	CODE_BRIGHTNESS_AUTO          = Code(C.KEY_BRIGHTNESS_AUTO)          /* 244   */
	CODE_BRIGHTNESS_ZERO          = Code(C.KEY_BRIGHTNESS_ZERO)          /* KEY_BRIGHTNESS_AUTO */
	...
	CODE_BRIGHTNESS_TOGGLE        = Code(C.KEY_BRIGHTNESS_TOGGLE)        /* KEY_DISPLAYTOGGLE */
	...
	CODE_NUMERIC_A                = Code(C.KEY_NUMERIC_A)                /* 0x20c */
	CODE_NUMERIC_B                = Code(C.KEY_NUMERIC_B)                /* 0x20d */
	CODE_NUMERIC_C                = Code(C.KEY_NUMERIC_C)                /* 0x20e */
	CODE_NUMERIC_D                = Code(C.KEY_NUMERIC_D)                /* 0x20f */
	...
	CODE_BUTTONCONFIG             = Code(C.KEY_BUTTONCONFIG)             /* 0x240 */
	CODE_TASKMANAGER              = Code(C.KEY_TASKMANAGER)              /* 0x241 */
	CODE_JOURNAL                  = Code(C.KEY_JOURNAL)                  /* 0x242 */
	CODE_CONTROLPANEL             = Code(C.KEY_CONTROLPANEL)             /* 0x243 */
	CODE_APPSELECT                = Code(C.KEY_APPSELECT)                /* 0x244 */
	CODE_SCREENSAVER              = Code(C.KEY_SCREENSAVER)              /* 0x245 */
	CODE_VOICECOMMAND             = Code(C.KEY_VOICECOMMAND)             /* 0x246 */
	CODE_BRIGHTNESS_MIN           = Code(C.KEY_BRIGHTNESS_MIN)           /* 0x250 */
	CODE_BRIGHTNESS_MAX           = Code(C.KEY_BRIGHTNESS_MAX)           /* 0x251 */
	CODE_KBDINPUTASSIST_PREV      = Code(C.KEY_KBDINPUTASSIST_PREV)      /* 0x260 */
	CODE_KBDINPUTASSIST_NEXT      = Code(C.KEY_KBDINPUTASSIST_NEXT)      /* 0x261 */
	CODE_KBDINPUTASSIST_PREVGROUP = Code(C.KEY_KBDINPUTASSIST_PREVGROUP) /* 0x262 */
	CODE_KBDINPUTASSIST_NEXTGROUP = Code(C.KEY_KBDINPUTASSIST_NEXTGROUP) /* 0x263 */
	CODE_KBDINPUTASSIST_ACCEPT    = Code(C.KEY_KBDINPUTASSIST_ACCEPT)    /* 0x264 */
	CODE_KBDINPUTASSIST_CANCEL    = Code(C.KEY_KBDINPUTASSIST_CANCEL)    /* 0x265 */
