...
const (
	...
	CODE_BTN_MISC                 = Code(C.BTN_MISC)                     /* 0x100 */
	CODE_BTN_0                    = Code(C.BTN_0)                        /* 0x100 */
	CODE_BTN_1                    = Code(C.BTN_1)                        /* 0x101 */
	CODE_BTN_2                    = Code(C.BTN_2)                        /* 0x102 */
	CODE_BTN_3                    = Code(C.BTN_3)                        /* 0x103 */
	CODE_BTN_4                    = Code(C.BTN_4)                        /* 0x104 */
	CODE_BTN_5                    = Code(C.BTN_5)                        /* 0x105 */
	CODE_BTN_6                    = Code(C.BTN_6)                        /* 0x106 */
	CODE_BTN_7                    = Code(C.BTN_7)                        /* 0x107 */
	CODE_BTN_8                    = Code(C.BTN_8)                        /* 0x108 */
	CODE_BTN_9                    = Code(C.BTN_9)                        /* 0x109 */
	CODE_BTN_MOUSE                = Code(C.BTN_MOUSE)                    /* 0x110 */
	CODE_BTN_LEFT                 = Code(C.BTN_LEFT)                     /* 0x110 */
	CODE_BTN_RIGHT                = Code(C.BTN_RIGHT)                    /* 0x111 */
	CODE_BTN_MIDDLE               = Code(C.BTN_MIDDLE)                   /* 0x112 */
	CODE_BTN_SIDE                 = Code(C.BTN_SIDE)                     /* 0x113 */
	CODE_BTN_EXTRA                = Code(C.BTN_EXTRA)                    /* 0x114 */
	CODE_BTN_FORWARD              = Code(C.BTN_FORWARD)                  /* 0x115 */
	CODE_BTN_BACK                 = Code(C.BTN_BACK)                     /* 0x116 */
	CODE_BTN_TASK                 = Code(C.BTN_TASK)                     /* 0x117 */
	CODE_BTN_JOYSTICK             = Code(C.BTN_JOYSTICK)                 /* 0x120 */
	CODE_BTN_TRIGGER              = Code(C.BTN_TRIGGER)                  /* 0x120 */
	CODE_BTN_THUMB                = Code(C.BTN_THUMB)                    /* 0x121 */
	CODE_BTN_THUMB2               = Code(C.BTN_THUMB2)                   /* 0x122 */
	CODE_BTN_TOP                  = Code(C.BTN_TOP)                      /* 0x123 */
	CODE_BTN_TOP2                 = Code(C.BTN_TOP2)                     /* 0x124 */
	CODE_BTN_PINKIE               = Code(C.BTN_PINKIE)                   /* 0x125 */
	CODE_BTN_BASE                 = Code(C.BTN_BASE)                     /* 0x126 */
	CODE_BTN_BASE2                = Code(C.BTN_BASE2)                    /* 0x127 */
	CODE_BTN_BASE3                = Code(C.BTN_BASE3)                    /* 0x128 */
	CODE_BTN_BASE4                = Code(C.BTN_BASE4)                    /* 0x129 */
	CODE_BTN_BASE5                = Code(C.BTN_BASE5)                    /* 0x12a */
	CODE_BTN_BASE6                = Code(C.BTN_BASE6)                    /* 0x12b */
	CODE_BTN_DEAD                 = Code(C.BTN_DEAD)                     /* 0x12f */
	CODE_BTN_GAMEPAD              = Code(C.BTN_GAMEPAD)                  /* 0x130 */
	CODE_BTN_SOUTH                = Code(C.BTN_SOUTH)                    /* 0x130 */
	CODE_BTN_A                    = Code(C.BTN_A)                        /* BTN_SOUTH */
	CODE_BTN_EAST                 = Code(C.BTN_EAST)                     /* 0x131 */
	CODE_BTN_B                    = Code(C.BTN_B)                        /* BTN_EAST */
	CODE_BTN_C                    = Code(C.BTN_C)                        /* 0x132 */
	CODE_BTN_NORTH                = Code(C.BTN_NORTH)                    /* 0x133 */
	CODE_BTN_X                    = Code(C.BTN_X)                        /* BTN_NORTH */
	CODE_BTN_WEST                 = Code(C.BTN_WEST)                     /* 0x134 */
	CODE_BTN_Y                    = Code(C.BTN_Y)                        /* BTN_WEST */
	CODE_BTN_Z                    = Code(C.BTN_Z)                        /* 0x135 */
	CODE_BTN_TL                   = Code(C.BTN_TL)                       /* 0x136 */
	CODE_BTN_TR                   = Code(C.BTN_TR)                       /* 0x137 */
	CODE_BTN_TL2                  = Code(C.BTN_TL2)                      /* 0x138 */
	CODE_BTN_TR2                  = Code(C.BTN_TR2)                      /* 0x139 */
	CODE_BTN_SELECT               = Code(C.BTN_SELECT)                   /* 0x13a */
	CODE_BTN_START                = Code(C.BTN_START)                    /* 0x13b */
	CODE_BTN_MODE                 = Code(C.BTN_MODE)                     /* 0x13c */
	CODE_BTN_THUMBL               = Code(C.BTN_THUMBL)                   /* 0x13d */
	CODE_BTN_THUMBR               = Code(C.BTN_THUMBR)                   /* 0x13e */
	CODE_BTN_DIGI                 = Code(C.BTN_DIGI)                     /* 0x140 */
	CODE_BTN_TOOL_PEN             = Code(C.BTN_TOOL_PEN)                 /* 0x140 */
	CODE_BTN_TOOL_RUBBER          = Code(C.BTN_TOOL_RUBBER)              /* 0x141 */
	CODE_BTN_TOOL_BRUSH           = Code(C.BTN_TOOL_BRUSH)               /* 0x142 */
	CODE_BTN_TOOL_PENCIL          = Code(C.BTN_TOOL_PENCIL)              /* 0x143 */
	CODE_BTN_TOOL_AIRBRUSH        = Code(C.BTN_TOOL_AIRBRUSH)            /* 0x144 */
	CODE_BTN_TOOL_FINGER          = Code(C.BTN_TOOL_FINGER)              /* 0x145 */
	CODE_BTN_TOOL_MOUSE           = Code(C.BTN_TOOL_MOUSE)               /* 0x146 */
	CODE_BTN_TOOL_LENS            = Code(C.BTN_TOOL_LENS)                /* 0x147 */
	CODE_BTN_TOOL_QUINTTAP        = Code(C.BTN_TOOL_QUINTTAP)            /* 0x148 */
	CODE_BTN_TOUCH                = Code(C.BTN_TOUCH)                    /* 0x14a */
	CODE_BTN_STYLUS               = Code(C.BTN_STYLUS)                   /* 0x14b */
	CODE_BTN_STYLUS2              = Code(C.BTN_STYLUS2)                  /* 0x14c */
	CODE_BTN_TOOL_DOUBLETAP       = Code(C.BTN_TOOL_DOUBLETAP)           /* 0x14d */
	CODE_BTN_TOOL_TRIPLETAP       = Code(C.BTN_TOOL_TRIPLETAP)           /* 0x14e */
	CODE_BTN_TOOL_QUADTAP         = Code(C.BTN_TOOL_QUADTAP)             /* 0x14f */
	CODE_BTN_WHEEL                = Code(C.BTN_WHEEL)                    /* 0x150 */
	CODE_BTN_GEAR_DOWN            = Code(C.BTN_GEAR_DOWN)                /* 0x150 */
	CODE_BTN_GEAR_UP              = Code(C.BTN_GEAR_UP)                  /* 0x151 */
	...
	CODE_BTN_DPAD_UP              = Code(C.BTN_DPAD_UP)                  /* 0x220 */
	CODE_BTN_DPAD_DOWN            = Code(C.BTN_DPAD_DOWN)                /* 0x221 */
	CODE_BTN_DPAD_LEFT            = Code(C.BTN_DPAD_LEFT)                /* 0x222 */
	CODE_BTN_DPAD_RIGHT           = Code(C.BTN_DPAD_RIGHT)               /* 0x223 */
	...
	CODE_BTN_TRIGGER_HAPPY        = Code(C.BTN_TRIGGER_HAPPY)            /* 0x2c0 */
	CODE_BTN_TRIGGER_HAPPY1       = Code(C.BTN_TRIGGER_HAPPY1)           /* 0x2c0 */
	CODE_BTN_TRIGGER_HAPPY2       = Code(C.BTN_TRIGGER_HAPPY2)           /* 0x2c1 */
	CODE_BTN_TRIGGER_HAPPY3       = Code(C.BTN_TRIGGER_HAPPY3)           /* 0x2c2 */
	CODE_BTN_TRIGGER_HAPPY4       = Code(C.BTN_TRIGGER_HAPPY4)           /* 0x2c3 */
	CODE_BTN_TRIGGER_HAPPY5       = Code(C.BTN_TRIGGER_HAPPY5)           /* 0x2c4 */
	CODE_BTN_TRIGGER_HAPPY6       = Code(C.BTN_TRIGGER_HAPPY6)           /* 0x2c5 */
	CODE_BTN_TRIGGER_HAPPY7       = Code(C.BTN_TRIGGER_HAPPY7)           /* 0x2c6 */
	CODE_BTN_TRIGGER_HAPPY8       = Code(C.BTN_TRIGGER_HAPPY8)           /* 0x2c7 */
	CODE_BTN_TRIGGER_HAPPY9       = Code(C.BTN_TRIGGER_HAPPY9)           /* 0x2c8 */
	CODE_BTN_TRIGGER_HAPPY10      = Code(C.BTN_TRIGGER_HAPPY10)          /* 0x2c9 */
	CODE_BTN_TRIGGER_HAPPY11      = Code(C.BTN_TRIGGER_HAPPY11)          /* 0x2ca */
	CODE_BTN_TRIGGER_HAPPY12      = Code(C.BTN_TRIGGER_HAPPY12)          /* 0x2cb */
	CODE_BTN_TRIGGER_HAPPY13      = Code(C.BTN_TRIGGER_HAPPY13)          /* 0x2cc */
	CODE_BTN_TRIGGER_HAPPY14      = Code(C.BTN_TRIGGER_HAPPY14)          /* 0x2cd */
	CODE_BTN_TRIGGER_HAPPY15      = Code(C.BTN_TRIGGER_HAPPY15)          /* 0x2ce */
	CODE_BTN_TRIGGER_HAPPY16      = Code(C.BTN_TRIGGER_HAPPY16)          /* 0x2cf */
	CODE_BTN_TRIGGER_HAPPY17      = Code(C.BTN_TRIGGER_HAPPY17)          /* 0x2d0 */
	CODE_BTN_TRIGGER_HAPPY18      = Code(C.BTN_TRIGGER_HAPPY18)          /* 0x2d1 */
	CODE_BTN_TRIGGER_HAPPY19      = Code(C.BTN_TRIGGER_HAPPY19)          /* 0x2d2 */
	CODE_BTN_TRIGGER_HAPPY20      = Code(C.BTN_TRIGGER_HAPPY20)          /* 0x2d3 */
	CODE_BTN_TRIGGER_HAPPY21      = Code(C.BTN_TRIGGER_HAPPY21)          /* 0x2d4 */
	CODE_BTN_TRIGGER_HAPPY22      = Code(C.BTN_TRIGGER_HAPPY22)          /* 0x2d5 */
	CODE_BTN_TRIGGER_HAPPY23      = Code(C.BTN_TRIGGER_HAPPY23)          /* 0x2d6 */
	CODE_BTN_TRIGGER_HAPPY24      = Code(C.BTN_TRIGGER_HAPPY24)          /* 0x2d7 */
	CODE_BTN_TRIGGER_HAPPY25      = Code(C.BTN_TRIGGER_HAPPY25)          /* 0x2d8 */
	CODE_BTN_TRIGGER_HAPPY26      = Code(C.BTN_TRIGGER_HAPPY26)          /* 0x2d9 */
	CODE_BTN_TRIGGER_HAPPY27      = Code(C.BTN_TRIGGER_HAPPY27)          /* 0x2da */
	CODE_BTN_TRIGGER_HAPPY28      = Code(C.BTN_TRIGGER_HAPPY28)          /* 0x2db */
	CODE_BTN_TRIGGER_HAPPY29      = Code(C.BTN_TRIGGER_HAPPY29)          /* 0x2dc */
	CODE_BTN_TRIGGER_HAPPY30      = Code(C.BTN_TRIGGER_HAPPY30)          /* 0x2dd */
	CODE_BTN_TRIGGER_HAPPY31      = Code(C.BTN_TRIGGER_HAPPY31)          /* 0x2de */
	CODE_BTN_TRIGGER_HAPPY32      = Code(C.BTN_TRIGGER_HAPPY32)          /* 0x2df */
	CODE_BTN_TRIGGER_HAPPY33      = Code(C.BTN_TRIGGER_HAPPY33)          /* 0x2e0 */
	CODE_BTN_TRIGGER_HAPPY34      = Code(C.BTN_TRIGGER_HAPPY34)          /* 0x2e1 */
	CODE_BTN_TRIGGER_HAPPY35      = Code(C.BTN_TRIGGER_HAPPY35)          /* 0x2e2 */
	CODE_BTN_TRIGGER_HAPPY36      = Code(C.BTN_TRIGGER_HAPPY36)          /* 0x2e3 */
	CODE_BTN_TRIGGER_HAPPY37      = Code(C.BTN_TRIGGER_HAPPY37)          /* 0x2e4 */
	CODE_BTN_TRIGGER_HAPPY38      = Code(C.BTN_TRIGGER_HAPPY38)          /* 0x2e5 */
	CODE_BTN_TRIGGER_HAPPY39      = Code(C.BTN_TRIGGER_HAPPY39)          /* 0x2e6 */
	CODE_BTN_TRIGGER_HAPPY40      = Code(C.BTN_TRIGGER_HAPPY40)          /* 0x2e7 */
