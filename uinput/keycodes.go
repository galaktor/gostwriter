...
const (
	...
	KEY_BRIGHTNESS_AUTO   = KeyCode(C.KEY_BRIGHTNESS_AUTO)   /* 244   */
	KEY_BRIGHTNESS_ZERO   = KeyCode(C.KEY_BRIGHTNESS_ZERO)   /* KEY_BRIGHTNESS_AUTO */
	...
	KEY_BRIGHTNESS_TOGGLE = KeyCode(C.KEY_BRIGHTNESS_TOGGLE) /* KEY_DISPLAYTOGGLE */
	...
	KEY_BUTTONCONFIG      = KeyCode(C.KEY_BUTTONCONFIG)      /* 0x240 */
	KEY_TASKMANAGER       = KeyCode(C.KEY_TASKMANAGER)       /* 0x241 */
	KEY_JOURNAL           = KeyCode(C.KEY_JOURNAL)           /* 0x242 */
	KEY_CONTROLPANEL      = KeyCode(C.KEY_CONTROLPANEL)      /* 0x243 */
	KEY_APPSELECT         = KeyCode(C.KEY_APPSELECT)         /* 0x244 */
	KEY_SCREENSAVER       = KeyCode(C.KEY_SCREENSAVER)       /* 0x245 */
	KEY_VOICECOMMAND      = KeyCode(C.KEY_VOICECOMMAND)      /* 0x246 */
	KEY_BRIGHTNESS_MIN    = KeyCode(C.KEY_BRIGHTNESS_MIN)    /* 0x250 */
	KEY_BRIGHTNESS_MAX    = KeyCode(C.KEY_BRIGHTNESS_MAX)    /* 0x251 */
